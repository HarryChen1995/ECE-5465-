...
CPP_SRCS += \
../eRPC_spi_slave_transport/erpc/infra/framed_transport.cpp 

OBJS += \
./eRPC_spi_slave_transport/erpc/infra/framed_transport.o 

CPP_DEPS += \
./eRPC_spi_slave_transport/erpc/infra/framed_transport.d 


# Each subdirectory must supply rules for building sources it contributes
eRPC_spi_slave_transport/erpc/infra/%.o: ../eRPC_spi_slave_transport/erpc/infra/%.cpp
	@echo 'Building file: $<'
