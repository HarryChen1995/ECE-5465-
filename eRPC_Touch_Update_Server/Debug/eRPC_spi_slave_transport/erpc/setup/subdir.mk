...
CPP_SRCS += \
../eRPC_spi_slave_transport/erpc/setup/erpc_setup_mbf_dynamic.cpp 

OBJS += \
./eRPC_spi_slave_transport/erpc/setup/erpc_setup_mbf_dynamic.o 

CPP_DEPS += \
./eRPC_spi_slave_transport/erpc/setup/erpc_setup_mbf_dynamic.d 


# Each subdirectory must supply rules for building sources it contributes
eRPC_spi_slave_transport/erpc/setup/%.o: ../eRPC_spi_slave_transport/erpc/setup/%.cpp
	@echo 'Building file: $<'
