...
CPP_SRCS += \
../erpc/service/erpc_matrix_multiply_server.cpp 

OBJS += \
./erpc/service/erpc_matrix_multiply_server.o 

CPP_DEPS += \
./erpc/service/erpc_matrix_multiply_server.d 


# Each subdirectory must supply rules for building sources it contributes
erpc/service/%.o: ../erpc/service/%.cpp
	@echo 'Building file: $<'
