...
CPP_SRCS += \
../eRPC_server/erpc/setup/erpc_server_setup.cpp 

OBJS += \
./eRPC_server/erpc/setup/erpc_server_setup.o 

CPP_DEPS += \
./eRPC_server/erpc/setup/erpc_server_setup.d 


# Each subdirectory must supply rules for building sources it contributes
eRPC_server/erpc/setup/%.o: ../eRPC_server/erpc/setup/%.cpp
	@echo 'Building file: $<'
